...
3. **skip-fresh promotion.** Lever shipped off. Prod-parity evidence so far: 5 clean pairs, zero quality drops, AgentCash spend eliminated, about 8.5s median wall savings. Batch 2 (10 more pairs) in flight; decision is Samay's on the combined table. The flip itself is a quiet-window operation (adds a conditional step to in-flight runs).
