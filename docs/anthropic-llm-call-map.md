...
| `analysis`, fresh | 3 to 13 (1 `extract_full` + 0-5 `extract_block` + 1 `synthesis` + 0-1 `emphasis_read` + 0-4 `how_it_wins` + 1 `verify`) |
| `analysis`, reusing stored profile | 2 to 7 (1 `synthesis` + 0-1 `emphasis_read` + 0-4 `how_it_wins` + 1 `verify`) |
