...
Every place Cold Start calls Anthropic's API or any LLM. First mapped at commit `66362f0` (2026-06-11); updated the same day for per-stage provider routing, on 2026-07-20 for person reads and OpenRouter, on 2026-07-23 for the verifier `max_tokens` cap raise, on 2026-07-27 for the expanded-description stage, and on 2026-08-11 for alternate-provider continuity. Line numbers drift; the stable identifiers are the trace `stage`, `label`, and `provider` values, which are recorded on every call.
