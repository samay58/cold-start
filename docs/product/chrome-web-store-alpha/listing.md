...
- Single purpose: Provide sourced company research in a side panel for the company website where the user explicitly opens Cold Start.
- Mature content: No
- Payments: No
- Ads: No

Before submission, confirm this copy matches the packaged build and that the support link exposes a working contact path.
