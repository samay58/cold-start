...
Date: 2026-07-20. Status: approved design, pre-plan. Companion plan: `docs/archive/plans/2026-07-20-investor-lens-overhaul.md`.
...
**Result surface: memo, not ledger.** This decision was amended on July 24 by the category-packet direction in `DESIGN.md`. The filed Lens remains one premium surface, but its five indexed categories now disclose one at a time instead of forming one continuous memo.
