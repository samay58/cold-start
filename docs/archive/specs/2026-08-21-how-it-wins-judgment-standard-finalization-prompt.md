...
1. `docs/archive/specs/2026-08-21-how-it-wins-judgment-standard-draft.md`
2. `docs/archive/specs/2026-08-21-how-it-wins-framework-mapping-round-2-ingestion.md`
3. `docs/archive/specs/2026-08-21-how-it-wins-framework-mapping-round-2-output.md`
4. `packages/core/src/how-it-wins.ts`
5. Steph Ango's primary source: `https://stephango.com/moats`
6. `docs/archive/specs/2026-08-21-how-it-wins-judge-architecture-draft.md`
7. `docs/archive/specs/2026-08-18-moat-read-design.md`, only the current How it wins status and next-steps sections
...
<state_updates>
Update `docs/archive/specs/2026-08-18-moat-read-design.md`, `eval/curation/notes/sitting-2-how-it-wins.md`, and the existing Phoenix task `task-cold-start-how-it-wins-blind-read` only after the final standard passes verification.
