...
3. `docs/archive/specs/2026-08-21-how-it-wins-judge-architecture-draft.md`
...
9. The current How it wins status and next-step sections in `docs/archive/specs/2026-08-18-moat-read-design.md`
...
- update the current status and next steps in `docs/archive/specs/2026-08-18-moat-read-design.md`
