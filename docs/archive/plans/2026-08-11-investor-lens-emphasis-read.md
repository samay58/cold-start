Status: shipped 2026-08-12 (4ecf705).

# Investor Lens Emphasis Read Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Ship the sixth gated Investor Lens category, `emphasisRead`, which reads what a company and its founders are loud about, what never appears in the filed record, and what that asymmetry means; per the approved spec `docs/archive/specs/2026-08-11-investor-lens-emphasis-read-design.md`.
