...
Pre-implementation. Spec approved 2026-05-06. Implementation plan to be generated by `/superpowers:writing-plans` next.
...
└── (apps/, packages/ scaffolded after writing-plans)
```
