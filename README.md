...
| `HOW_IT_WINS_ENABLED`                                                     | Enables the How it wins read: the memoized `how-it-wins` Inngest step and its judge-then-writer inside analysis runs that clear the thin-file check (default on; production is on as of 2026-08-24; set `false` to roll back).                                                                                                                                                             |
| `LLM_HOW_IT_WINS_MODEL`                                                   | Writer model for the How it wins reasoning, edit, and fit passes. Falls back to the synthesis model chain when unset.                                                                                                                                                                                                                                                                    |
