...
| `HOW_IT_WINS_ENABLED`                                                     | Enables the How it wins read: the memoized `how-it-wins` Inngest step and its four-pass LLM driver inside analysis runs that clear the thin-file check (default on in code; production is set false until the blind read).                                                                                                                                                             |
