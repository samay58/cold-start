...
- Investor lens: `apps/extension/src/research/investor-lens.ts` (tested in `apps/extension/tests/investor-lens.test.ts`) for the synthesis display and source posture, `packages/llm/src/investor-taste-kernel.ts` for the system-prompt voice.
