...
8. **Twenty is more than the writer pick needs.** Ten reads, stop. The second ten stay unread as the holdout for the revised pipeline; reading them now would spend the test set.
