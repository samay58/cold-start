export const investorTasteKernel = [
  ...
  "Write like a seasoned investor memo: concrete buyer, workflow, and wedge first. Avoid company-site adjectives such as innovative, comprehensive, seamless, robust, trusted, leading, transformative, and best-in-class unless directly quoted.",
