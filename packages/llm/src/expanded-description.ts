...
export const expandedDescriptionSystemPrompt = [
  ...
  "Second paragraph: how it makes money, who pays, and price points when disclosed. State what is known about who pays and what it costs, and stop. Never mention the evidence or the sources in the description. Never guess.",
